...
const events = [
  ...
  {
    id: "3", title: "Startup Pitch Night", description: "Present your ideas to real investors and industry mentors.", date: "2024-05-20", time: "6:00 PM",
    location: "Innovation Hub", category: "Career", attendees: 80, maxAttendees: 100, organizer: "E-Cell",
    image: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=600&q=80",
    tags: ["startup", "pitch", "funding"], featured: false
  },
  {
    id: "4", title: "Cultural Night 2024", description: "An evening of music, dance, and artistic performances.", date: "2024-05-22", time: "5:30 PM",
    location: "Open Air Theatre", category: "Cultural", attendees: 500, maxAttendees: 800, organizer: "Cultural Committee",
    image: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=600&q=80",
    tags: ["music", "dance", "fun"], featured: false
  },
  {
    id: "5", title: "Cybersecurity CTF", description: "Capture the flag competition for aspiring security researchers.", date: "2024-05-25", time: "9:00 AM",
    location: "CS Lab 1", category: "Hackathon", attendees: 90, maxAttendees: 120, organizer: "InfoSec Club",
    image: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=600&q=80",
    tags: ["security", "ctf", "hacking"], featured: false
  },
  {
    id: "6", title: "Research Paper Writing Seminar", description: "Learn IEEE/ACM paper formatting and publication strategies.", date: "2024-05-28", time: "11:00 AM",
    location: "Seminar Hall", category: "Seminar", attendees: 35, maxAttendees: 50, organizer: "Research Cell",
    image: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=600&q=80",
    tags: ["research", "paper", "academic"], featured: false
  },
];
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-3">
            {canCreateEvent && (
              <button className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-accent to-electric px-5 py-2.5 text-sm font-semibold text-white shadow-glow-sm transition-shadow hover:shadow-neon">
            ...
            {filteredEvents.filter(e => selectedCategory !== "All" || searchQuery || !e.featured).map((event) => (
              ...
              >
                <GlassCard hover className="group h-full">
                  ...
                  <button className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-lg bg-white/[0.04] py-2 text-xs font-medium text-white transition-colors hover:bg-white/[0.08]">
