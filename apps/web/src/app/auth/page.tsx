      ...
      >
        ...
        {process.env.NODE_ENV === "development" && (
          <motion.div
            ...
            className="mt-12 rounded-3xl border border-white/[0.06] bg-white/[0.02] p-6 text-center"
          >
            <h3 className="mb-4 text-xs font-semibold uppercase tracking-wider text-slate">Dev: Test Accounts</h3>
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="rounded-xl bg-white/[0.04] p-3 text-xs font-medium text-white transition-colors hover:bg-white/10"
              >
                Super Admin
              </button>
              <button
                onClick={() => {
                  useAuthStore.getState().mockLogin("college_admin", "NSUT", "Netaji Subhas University");
                  router.push("/admin");
                }}
                className="rounded-xl bg-white/[0.04] p-3 text-xs font-medium text-white transition-colors hover:bg-white/10"
              >
              ...
              <button
                onClick={() => {
                  useAuthStore.getState().mockLogin("college_admin", "IITD", "IIT Delhi");
                  router.push("/admin");
                }}
                className="rounded-xl bg-white/[0.04] p-3 text-xs font-medium text-white transition-colors hover:bg-white/10"
              >
              ...
              <button
                onClick={() => {
                  useAuthStore.getState().mockLogin("student");
                  router.push("/");
                }}
                className="rounded-xl bg-white/[0.04] p-3 text-xs font-medium text-white transition-colors hover:bg-white/10"
              >
